      ...
      <div className="flex items-center justify-center min-h-screen px-3 sm:px-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <h3 className="text-base md:text-lg font-semibold text-gray-900">Add New Operator</h3>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`input text-xs md:text-sm py-2 ${errors.password ? 'input-error' : ''}`}
                placeholder="••••••••"
              />
              {errors.password && (
            ...
            <div>
              ...
              <input
                ...
                className={`input text-xs md:text-sm py-2 ${errors.confirmPassword ? 'input-error' : ''}`}
                placeholder="••••••••"
              />
